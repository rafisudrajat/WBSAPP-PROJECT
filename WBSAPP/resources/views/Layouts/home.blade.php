  ...
  <div class="relative min-h-screen md:flex">
    ...
    <div class="flex-1 p-10 font-bold">
      <div class="flex justify-center relative">
        ...
        <svg id="menu-btn" width="60" height="60" viewBox="-4.5 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute top-0 right-0">
      ...
      <div class="absolute right-1.5 bg-gray-200 hidden flex-col rounded mt-1 p-2 text-sm w-32 z-50" id="dropdown">
        <div class="flex flex-col">
          <svg id="menu-btn" width="60" height="60" viewBox="-4.5 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" class="self-center">
            <path d="M45.5 0C20.384 0 0 20.384 0 45.5C0 70.616 20.384 91 45.5 91C70.616 91 91 70.616 91 45.5C91 20.384 70.616 0 45.5 0ZM45.5 13.65C53.053 13.65 59.15 19.747 59.15 27.3C59.15 34.853 53.053 40.95 45.5 40.95C37.947 40.95 31.85 34.853 31.85 27.3C31.85 19.747 37.947 13.65 45.5 13.65ZM45.5 78.26C34.125 78.26 24.0695 72.436 18.2 63.609C18.3365 54.5545 36.4 49.595 45.5 49.595C54.5545 49.595 72.6635 54.5545 72.8 63.609C66.9305 72.436 56.875 78.26 45.5 78.26Z" fill="black"/>
          </svg>
          <a href="#" class="px-2 py-1 hover:bg-blue-300 rounded">my Profile</a>
          <a href="#" class="px-2 py-1 hover:bg-blue-300 rounded">Setting</a>
          <a href="{{route('logout')}}" class="px-2 py-1 hover:bg-blue-300 rounded">Logout</a>          
        </div>
      </div>  
      @yield('content')
    </div>
