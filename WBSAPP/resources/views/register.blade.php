    ...
    <div class="flex flex-col bg-white rounded-tr-3xl rounded-bl-3xl px-10 pt-6 pb-8 ring-4 ring-gray-900" style="width: 576px; flex-basis: 500px;">
        ...
        <form action="{{route('register.submit')}}" method="post">
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="fullname" name="fullname" type="text" placeholder="Username" value="{{old('fullname')}}">
                <span class="text-red-600 text-xs">@error('fullname') {{$message}} @enderror</span>
            </div>
            <!-- Email -->
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="email" name="email" type="text" placeholder="Email" value="{{old('email')}}">
            ...
            <div class="flex flex-col items-center">
                ...
                <p class="underline text-xs py-1">Already have an account? <a href="/" class="font-bold">Login Here</a> </p>
                <p class="text-xs"> OR</p>
                <p class="text-xs"> Continue With Social Media</p>
            </div>
        </form>
    </div>
@endsection